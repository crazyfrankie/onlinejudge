...
// Source: D:\Gocode\oj\internal\article\service\article.go
...
import (
	context "context"
	domain "oj/internal/article/domain"
	reflect "reflect"
...
func (m *MockArticleService) Publish(ctx context.Context, art domain.Article) (uint64, error) {
	m.ctrl.T.Helper()
...
func (m *MockArticleService) Save(ctx context.Context, art domain.Article) (uint64, error) {
	m.ctrl.T.Helper()
