...
// Source: D:\Gocode\oj\internal\user\service\code.go
...
// GenerateHMAC mocks base method.
func (m *MockCodeService) GenerateHMAC(code, key string) string {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GenerateHMAC", code, key)
	ret0, _ := ret[0].(string)
	return ret0
}

// GenerateHMAC indicates an expected call of GenerateHMAC.
func (mr *MockCodeServiceMockRecorder) GenerateHMAC(code, key interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GenerateHMAC", reflect.TypeOf((*MockCodeService)(nil).GenerateHMAC), code, key)
}
